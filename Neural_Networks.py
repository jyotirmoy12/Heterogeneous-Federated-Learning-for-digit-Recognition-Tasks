...
def cnn_4layer_fc_model(n_classes, n1=128, n2=192, n3=256, n4=320, dropout_rate=0.2, input_shape=(28, 28)):
    model_A, x = None, None
    ...
    y = Conv2D(filters=n4, kernel_size=(3, 3), strides=2, padding="valid", activation=None)(y)
    y = BatchNormalization()(y)
    y = Activation("relu")(y)
    y = Dropout(dropout_rate)(y)
    #y = AveragePooling2D(pool_size=(2, 2), strides=2, padding="valid")(y)
